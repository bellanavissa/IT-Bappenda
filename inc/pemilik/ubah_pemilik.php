...
require 'inc/koneksi.php';
    ...
    // var_dump($nopol);
    // die();
    $query = mysqli_query($koneksi, "SELECT * FROM tbl_wp WHERE id_wp = '$id_wp'");
    $row = mysqli_fetch_assoc($query);

    if (isset($_POST['submit'])) {

    $id_wp = mysqli_real_escape_string($koneksi, $_POST['id_wp']);
        ...
        <div class="w-full max-w-4xl bg-white rounded-lg overflow-hidden form-container p-8">
            <div class="text-center mb-8">
                ...
                <div class="col-sm-4">
                    ...
                    <input type="hidden" name="id_wp" value="<?= $row["id_wp"]; ?>">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                        <input type="text" name="alamat" class="form-control" id="alamat" required value="<?= $row["alamat"]; ?>">
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="no_ktp" class="col-sm-2 col-form-label">No. Ktp</label>
                        <div class="col-sm-10">
                        <input type="text" name="no_ktp" class="form-control" id="no_ktp" required value="<?= $row["no_ktp"]; ?>">
                        </div>
                    </div>
                   <div class="mb-3 row">
                        <label for="no_hp" class="col-sm-2 col-form-label">No. HP</label>
                        <div class="col-sm-10">
                        <input type="text" name="no_hp" class="form-control" id="no_hp" required value="<?= $row["no_hp"]; ?>">
                        </div>
                    </div>
